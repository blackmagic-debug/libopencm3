...
@{*/
#define DMA_CHANNEL0                  1U
#define DMA_CHANNEL1                  2U
#define DMA_CHANNEL2                  3U
#define DMA_CHANNEL3                  4U
#define DMA_CHANNEL4                  5U
#define DMA_CHANNEL5                  6U
#define DMA_CHANNEL6                  7U
#define DMA_CHANNEL7                  8U
#define DMA_CHANNEL8                  9U
#define DMA_CHANNEL9                  10U
#define DMA_CHANNEL10                 11U
#define DMA_CHANNEL11                 12U
#define DMA_CHANNEL12                 13U
#define DMA_CHANNEL13                 14U
#define DMA_CHANNEL14                 15U
#define DMA_CHANNEL15                 16U
/**@}*/

#define DMA_CHANNEL(periph, n)  ((periph) + 0x50U + (0x80U * (n)))

/* --- DMA controller registers -------------------------------------------- */

/* --- DMA channel registers ----------------------------------------------- */

/* DMA Channel x Flag Clear Register (DMA_SxFCR) */
...
#define DMA_TCIF            (1U << 8U)
/** Half Transfer Interrupt Flag */
#define DMA_HTIF            (1U << 9U)
/** Data Transfer Error Interrupt Flag */
#define DMA_DTEIF           (1U << 10U)
/** Update Link Transfer Error Interrupt Flag */
#define DMA_ULEIF           (1U << 11U)
/** User Setting Error Interrupt Flag */
#define DMA_USEIF           (1U << 12U)
/** Completed Suspension Interrupt Flag */
#define DMA_SUSPIF          (1U << 13U)
/** Trigger Overrun Interrupt Flag */
#define DMA_TOIF            (1U << 14U)
/**@}*/

#define DMA_ISR_FLAGS		(DMA_TCIF | DMA_HTIF | DMA_DTEIF | DMA_ULEIF | \
				 DMA_USEIF | DMA_SUSPIF | DMA_TOIF)

/* DMA Channel x Status Register (DMA_SxSR) */
...
/* DMA Channel x Control Register (DMA_SxCR) */
...
/* DMA Channel x Transfer Register 1 (DMA_SxTR1) */
...
/* DMA Channel x Transfer Register 2 (DMA_SxTR2) */
...
/* DMA Channel x Block Register 1 (DMA_SxBR1) */
...
/* DMA Channel x Source Address Register (DMA_SxSAR) */
...
/* DMA Channel x Destination Address Register (DMA_SxDAR) */
...
/* DMA Channel x Transfer Register 3 (DMA_SxTR3) */
